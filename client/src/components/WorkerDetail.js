   ...
   const handleFollowClick = async()=>{ 
    ...
    const user_id = localStorage.getItem("user_id");
      const response = await fetch(`${host}/request/send`, {
        ...
        body: JSON.stringify({fullname: userData.name,picture: userData.profile_picture, occupation: userData.occupation, status: "pending", receivingid: worker._id, sendingid: user_id})
      }) 
      const json = await response.json();
     ...
     window.location.href = "/workerdetail";
   }
