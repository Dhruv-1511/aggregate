...
const FarmerNotify = () => {
  ...
  const {getUserData , userData, getAllFarmerRequest, allFarmerRequest} = context;
  ...
  useEffect(() => {
    ...
    const handleAcceptBtn = async(senderid) =>{
      const response = await fetch(`${host}/request/updatestatus`, {
        ...
        body: JSON.stringify({sendingid: senderid, receivingid: user_id, status: "accept"})
      })
      const json = await response.json();
      getAllFarmerRequest(user_id);
      ...
      <div className="dashboard-right-sidebar">
        <div className="row mb-2-2">
          <div className="col-lg-12 mb-1-9">
            <h3 className="mb-3">Job Alerts</h3>
          </div>
          <div className="col-lg-12">
              ...
              <div className="d-md-flex justify-content-between align-items-center">
                <div className="mb-4 mb-md-0">
                  <h4 className="mb-0 h5">
                    Recently <span className="text-primary">Job Requests</span>
                  </h4>
                </div>
                <form
                  action="#!"
                ...
                <table className="table custome-table">
                  ...
                  {allFarmerRequest && allFarmerRequest.map((e)=>{
                    return (
                      <tr key={e._id}>
                      <td>
                        <img src={e.picture == null ? "img/avatar/user.png" : e.picture} 
                      ...
                      <td>
                      <span className="text display-30 text-clr" style={{backgroundColor: '#29a45f', padding: '6px', color: 'white',borderRadius: '11px'}}>
                       Pending
                        </span>
                      </td>
                      <td>
                        <ul className="action-list">
                          <li>
                            ...
                            onClick={() => handleOnClick(e.sendingid)}
                            >
    ...
    <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div className="modal-content">
        ...
        <div className="modal-body">
          ...
          <br />
          <span>
            About : {workerD[0].about }
          </span>
          <br />
          <span>
            Address : {workerD[0].address}
          </span>
          <br />
          <span>
            Age : {workerD[0].age}
          ...
          <br />
          <span>
          Phone : {workerD[0].phone}
          </span>
          <br />
          <span>
          Rating : {workerD[0].rating}
          </span>
          <br />
          <span>
          Work Hour : {workerD[0].work_hour}
          </span>
          <br />
        </div>
      }
        <div className="modal-footer">
          ...
          >
            Close
                          ...
                          <li>
                            <a href="#!" onClick={() => handleAcceptBtn(e.sendingid)}>
                              <span className="ti-check"  />
                            </a>
                          </li>
                          <li>
                            <a href="#!" onClick={() => handleRejectBtn(e.sendingid)}>
