...
const FarmerNav = (props) => {
  ...
  const handleOnNotify =async () =>{
    ...
    // const json = await response.json();
    // // console.log(json)
    window.location.href = "/farmernotify" 
  }
            ...
            <div className="menu_area alt-font">
              <nav className="navbar navbar-expand-lg navbar-light p-0">
                ...
                >
                  ...
                  <li>
                    <Link to="/farmercrop">Crop</Link>
                  </li>
                  <li>
                    <Link to="/farmerchat">Message</Link>
                  </li>
                  <li>
                    <Link to="/farmerabout">About Us</Link>
                  </li>
                  <li>
                    <Link to="/farmercontact">Contact Us</Link>
                  </li>
                  <li><a href="#!">Explore</a>
                                            <ul>
                                                <li>    <Link to="/farmerpostjob">Post job</Link>
                                                </li>
                                                <li>
                                                <Link to="/farmercropsell">Upload Crop</Link>
                                                </li>
                                                <li>
