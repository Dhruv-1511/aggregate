...
const FarmerEqDetail = () => {
    const host = process.env.REACT_APP_HOST;
  const context = useContext(AAContext);
  const { getAllFarmerRequest, allFarmerRequest, getAllequipment, allequipment } = context;
            ...
            <div className="col-lg-12">
                ...
                <div className="row align-items-center">
                    ...
                    <div className="d-lg-flex align-items-center text-center text-lg-start">
                        ...
                        >
                        <img
                            src={e.equipment_photo == null ? "img/bg/onion.jpg" : e.equipment_photo}
                            alt="..."
                    ...
                    <div className="row">
                        ...
                        <Link to="/farmercheckout" className="butn mb-3 w-100 text-center">
                            Buy Now
                        </Link>
                        </div>
                        {/* <div className="col-12">
                ...
                <div className="row">
                    ...
                    <div className="p-1-6 border border-color-extra-light-gray border-radius-10">
                        ...
                        <div className="col-sm-6 col-md-4 mt-3">
                            ...
                            <h5 className="display-29 display-xl-28">Posted on</h5>
                        ...
                        <div className="col-sm-6 col-md-4 mt-3">
                            <div className="border border-color-extra-light-gray py-3 px-4 border-radius-10">
                            <h5 className="display-29 display-xl-28">Posted By</h5>
                            <span className="font-weight-500 text-primary display-30">
                               {e.name}
                            </span>
                            </div>
                        ...
                        <div className="col-sm-6 col-md-4 mt-3">
                            <div className="border border-color-extra-light-gray py-3 px-4 border-radius-10">
                            <h5 className="display-29 display-xl-28">Contact No.</h5>
                            <span className="font-weight-500 text-primary display-30">
                                {e.phone}
                            </span>
                            </div>
